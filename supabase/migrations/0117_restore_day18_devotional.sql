-- Restores Shelly's original Day 18 devotional HTML (footer + day-nav intact),
-- reversing an earlier suppression that had stripped those sections out entirely
-- rather than just hiding them -- decided 2026-07-31: leave her material exactly
-- as she made it unless there's a real problem with it. Read directly from her
-- original file (Post Day 2 Ingest/LCP Sample Materials/.../Basement_Day18_Mary)
-- via dollar-quoting to avoid any apostrophe-escaping risk in the HTML content.
update lcp_resources
set content = $content$<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .story-continued { font-family: 'Jost', sans-serif; font-size: 10px; font-weight: 500; letter-spacing: 0.2em; text-transform: uppercase; color: #8A6E08; margin-top: 16px; padding-top: 14px; border-top: 1px solid rgba(138,110,8,0.2); }
  ...
  .week-close { background: #F2F8F4; border-top: 2px solid #2A7A65; padding: 24px 28px; }
  .week-close-label { font-family: 'Jost', sans-serif; font-size: 9px; font-weight: 500; letter-spacing: 0.25em; text-transform: uppercase; color: #2A7A65; margin-bottom: 10px; }
  .week-close-text { font-family: 'Cormorant Garamond', Georgia, serif; font-size: 16px; font-style: italic; color: #133028; line-height: 1.7; }
  ...
  .footer a { color: #C8A020; text-decoration: none; }
...
<div class="email-wrap">
  ...
  </div>  <div class="day-nav">
    <span>Week 4 of 4</span>
    <div class="day-dots"><div class="dot"></div><div class="dot"></div><div class="dot active"></div><div class="dot"></div><div class="dot"></div></div>
    <span>Day 18 of 20</span>
  </div>  <div class="footer">
    <p>Sparrow LifeChange Program &nbsp;&middot;&nbsp; Corvallis, OR<br>
    <a href="mailto:lifechangedirector@sparrowinc.org">lifechangedirector@sparrowinc.org</a> &nbsp;&middot;&nbsp; <a href="http://www.sparrowinc.org">www.sparrowinc.org</a></p>
    <p style="margin-top:10px;"><em>Tomorrow: The first yes that started everything.</em></p>
    <p style="margin-top:8px;">You are receiving this because you are part of the Sparrow LifeChange Program community.</p>
  </div>
</div>
</body>
</html>$content$
where id = 'b9d860d6-dbd5-4df1-98b2-dae32d413486'
  and kind = 'devotional';
