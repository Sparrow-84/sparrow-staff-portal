export const LABEL_COLORS: { id: string; swatch: string; pill: string }[] = [
  ...
  { id: 'yellow',  swatch: 'bg-yellow-400',    pill: 'bg-yellow-100 text-yellow-700' },
  ...
  { id: 'rose',    swatch: 'bg-rose-400',      pill: 'bg-rose-100 text-rose-700' },
  { id: 'pink',    swatch: 'bg-pink-400',      pill: 'bg-pink-100 text-pink-700' },
  { id: 'fuchsia', swatch: 'bg-fuchsia-400',   pill: 'bg-fuchsia-100 text-fuchsia-700' },
  { id: 'violet',  swatch: 'bg-violet-400',    pill: 'bg-violet-100 text-violet-700' },
  { id: 'indigo',  swatch: 'bg-indigo-400',    pill: 'bg-indigo-100 text-indigo-700' },
];
