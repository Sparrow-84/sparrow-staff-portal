    ...
    <div>
      ...
      <div className="rounded-xl border border-sparrow-gold/30 bg-sparrow-cream px-4 py-3 text-sm">
        ...
        <ul className="mt-2 space-y-1 text-sparrow-gray dark:text-sparrow-dark-gray">
          <li>
            <span className="font-medium text-sparrow-ink dark:text-sparrow-dark-ink">Structured interview</span> — Written consent
            before the interview.
          </li>
          <li>
            <span className="font-medium text-sparrow-ink dark:text-sparrow-dark-ink">Google Form</span> — Consent is built into
            the form.
          </li>
          <li>
            <span className="font-medium text-sparrow-ink dark:text-sparrow-dark-ink">Participant freewrite</span> — Participant
            wrote their own story.
          </li>
          <li>
            <span className="font-medium text-sparrow-ink dark:text-sparrow-dark-ink">Staff Testimonial</span> — The subject is a
