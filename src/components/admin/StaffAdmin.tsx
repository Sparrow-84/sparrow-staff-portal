...
export function StaffAdmin() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-sparrow-gray">
            Add people, set their role &amp; department (which controls access), or deactivate them.
          </p>
        </div>
      ...
      <div className="mt-6 overflow-x-auto rounded-xl border border-sparrow-rule bg-white">
