      ...
      <div className="w-full max-w-lg rounded-2xl bg-white shadow-xl" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="space-y-6 px-6 py-5">
          <section className="rounded-xl bg-sparrow-mist/60 px-4 py-4">
            <h3 className="mb-3 text-xs font-semibold uppercase tracking-wide text-sparrow-gray">The 4 tabs</h3>
            <ul className="space-y-2 text-xs leading-relaxed text-sparrow-gray">
              <li><strong className="text-sparrow-ink">Active Grants</strong> — grants Sparrow currently holds, with ongoing compliance to track (certification dates, funder consent, notifications).</li>
              <li><strong className="text-sparrow-ink">Being Pursued</strong> — leads still in motion: not yet researched, being researched, decided to pursue, or applied and waiting to hear back.</li>
              <li><strong className="text-sparrow-ink">Not Moving Forward</strong> — leads that ended without funding, whether Sparrow chose not to apply or applied and was declined. Kept for the record of why.</li>
              <li><strong className="text-sparrow-ink">Past Grants</strong> — Active Grants that have wrapped up. Every field, link, and document stays exactly as it was — nothing gets stripped out.</li>
            </ul>
          </section>

          <section className="rounded-xl bg-sparrow-mist/60 px-4 py-4">
            <h3 className="mb-3 text-xs font-semibold uppercase tracking-wide text-sparrow-gray">Tier &amp; Source labels</h3>
          ...
          <section className="rounded-xl bg-sparrow-mist/60 px-4 py-4">
            <h3 className="mb-3 text-xs font-semibold uppercase tracking-wide text-sparrow-gray">Applied → Awarded</h3>
            <p className="text-xs leading-relaxed text-sparrow-gray">
          ...
          <section className="rounded-xl bg-sparrow-mist/60 px-4 py-4">
            <h3 className="mb-3 text-xs font-semibold uppercase tracking-wide text-sparrow-gray">Prior consent required (Active Grants only)</h3>
            <p className="text-xs leading-relaxed text-sparrow-gray">
